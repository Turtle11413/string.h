...
START_TEST(test_sprintf15) {
  ...
  ck_assert_int_eq(s21_sprintf(str1, format, 1, 222, (short int)33333333333, -166513.1232),
                   sprintf(str2, format, 1, 222, (short int)33333333333, -166513.1232));
...
Suite *suite_sprintf(void) {
  ...
  tcase_add_test(tc, unsigned_val_many_flags); // "undefined behaviour" (mine is correct tho)
  ...
  tcase_add_test(tc, e_width); // incorrect
